...
target_url = f"{base_url}/index.php?page=register.php"
print(target_url)
print("")
...
form_fields = ['username', 'password', 'confirm_password', 'my_signature']
...
for field in form_fields:
    for vulnerability_type, payload in payloads.items():
        ...
        if test_response.status_code in (200, 201, 202, 204) and "Registration failed" not in test_response.text:
